...
1. Go to the [GitHub Issues](https://github.com/reactive-resume/app/issues) page
2. Click **New Issue**
...
<CardGroup cols={2}>
  ...
  <Card icon="github" title="GitHub Issues" href="https://github.com/reactive-resume/app/issues">
