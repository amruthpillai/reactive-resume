...
- Closed after reporter confirmation. If it returns, request sanitized JSON, precise font/style configuration and image digest rather than assuming a rendering fix.
