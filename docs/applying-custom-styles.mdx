...
<!-- SEMANTIC-CSS-EXAMPLE:valid FIRST_CHANGE -->
```css
@version 1;
...
<!-- SEMANTIC-CSS-EXAMPLE:valid TARGETING -->
```css
@version 1;
...
<!-- SEMANTIC-CSS-EXAMPLE:valid BUILDER_VALUES -->
```css
@version 1;
...
<!-- SEMANTIC-CSS-EXAMPLE:valid RICH_TEXT_LISTS -->
```css
@version 1;
...
<!-- SEMANTIC-CSS-EXAMPLE:valid ITEM_FIELDS -->
```css
@version 1;
...
<!-- SEMANTIC-CSS-EXAMPLE:valid TEMPLATE_PART -->
```css
@version 1;
...
<!-- SEMANTIC-CSS-EXAMPLE:valid PDF_LAYOUT -->
```css
@version 1;
...
<!-- SEMANTIC-CSS-EXAMPLE:valid PDF_MEDIA_QUERY -->
```css
@version 1;
