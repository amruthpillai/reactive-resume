...
<Steps>
	<Step title="Clone the Repository">
		```bash
		git clone https://github.com/reactive-resume/app.git reactive-resume
		cd reactive-resume
		```
	</Step>
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/reactive-resume/app/issues) or reach out via
