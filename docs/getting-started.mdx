...
<AccordionGroup>
	<Accordion title="Completely Free & Open Source" icon="code-branch">
		...
		entire codebase is available on [GitHub](https://github.com/reactive-resume/app).
	</Accordion>
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/reactive-resume/app">
    Star the repo, report reproducible bugs, propose features, and contribute to the project.
  </Card>
  <Card title="GitHub Discussions" icon="comments" href="https://github.com/reactive-resume/app/discussions/categories/q-a">
...
<Note>
  **Need help?** Start a [GitHub Discussion](https://github.com/reactive-resume/app/discussions/categories/q-a).
