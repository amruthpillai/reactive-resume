...
The project repository is on [GitHub](https://github.com/reactive-resume/app). You can read the code, report issues, contribute improvements, and see how the builder, the API, the self-hosting setup, and the documentation are put together.
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub repository" icon="github" href="https://github.com/reactive-resume/app">
