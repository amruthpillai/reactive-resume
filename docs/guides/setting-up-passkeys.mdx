...
<Step title="Name your passkey">
  ...
  <Step title="Complete the passkey prompt">
    Your browser or device shows a passkey prompt (WebAuthn). Follow the on-screen instructions to register the passkey with your biometric (Face ID / Touch ID / fingerprint) or device PIN.
